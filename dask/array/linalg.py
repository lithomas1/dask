...
def svd(a, coerce_signs=True, full_matrices=False):
    ...
    full_matrices: bool
        ...
        Note: full_matrices=True is only implemented in the single-chunk case
    ...
    # Multi-chunk cases
        ...
        if full_matrices:
            raise NotImplementedError("full_matrices=True is only implemented for the single-chunk case")
